...
\includegraphics[height=2cm]{graphs/LogoSBE.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{graphs/mastermind}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.4\textwidth]{graphs/entropy}
...
\includegraphics[width=\textwidth]{graphs/graph1}
\end{boxedminipage}
\hspace{0.1\textwidth}
\begin{boxedminipage}{0.4\textwidth}
\includegraphics[width=\textwidth]{graphs/graph2}
\end{boxedminipage}
